...
def My_Amazing_Grid():
    ...
    B2 = pp.create_bus(net, vn_kv = 380, name= "B2")
    B3 = pp.create_bus(net, vn_kv = 150, name= "B3")
    B4 = pp.create_bus(net, vn_kv = 15, name= "B4")
    B5 = pp.create_bus(net, vn_kv = 380, name= "B5")
    B6 = pp.create_bus(net, vn_kv = 380, name= "B6")
    B7 = pp.create_bus(net, vn_kv = 20, name= "B7")
    B8 = pp.create_bus(net, vn_kv = 150, name= "B8")
    B12 = pp.create_bus(net, vn_kv = 20, name= "B12")
    B13 = pp.create_bus(net, vn_kv = 150, name= "B13")
    B14 = pp.create_bus(net, vn_kv = 15, name= "B14")
    B16 = pp.create_bus(net, vn_kv = 15, name= "B16")
    ...
    # Création Lines
    LINE_B2B5 = pp.create_line(net, from_bus=B2, to_bus=B5, length_km=1, std_type="_380kv_type", name="LINE_B2B5")
    ...
    # Création Generators
    G_B1 = pp.create_gen(net, bus=B1, p_mw=650, max_q_mvar=675, min_q_mvar=-250, sn_mva=1000, vm_pu=1, slack=False, name="G_B1")
    G_B7 = pp.create_gen(net, bus=B7, p_mw=650, max_q_mvar=675, min_q_mvar=-250, sn_mva=1000, vm_pu=1, slack=False, name="G_B7")
    G_B12 = pp.create_gen(net, bus=B12, p_mw=300, max_q_mvar=200, min_q_mvar=-50, sn_mva=450, vm_pu=0.98, slack=False, name="G_B12")
    ...
    # Sortie Grid 3
    LINE_B6B9_1 = pp.create_line(net, from_bus=B6, to_bus=B9, length_km=1, std_type="_380kv_type", name="LINE_B6B9_1")
    LINE_B6B9_2 = pp.create_line(net, from_bus=B6, to_bus=B9, length_km=1, std_type="_380kv_type", name="LINE_B6B9_2")

    LINE_B6B24 = pp.create_line(net, from_bus=B6, to_bus=B24, length_km=1, std_type="_380kv_type", name="LINE_B6B24")
    LINE_B6B17 = pp.create_line(net, from_bus=B6, to_bus=B17, length_km=1, std_type="_380kv_type", name="LINE_B6B17")

    LINE_B8B16 = pp.create_line(net, from_bus=B8, to_bus=B19, length_km=1, std_type="_150kv_type", name="LINE_B8B19")
    LINE_B10B13 = pp.create_line(net, from_bus=B10, to_bus=B13, length_km=1, std_type="_150kv_type", name="LINE_B10B13")
    LINE_B13B25 = pp.create_line(net, from_bus=B13, to_bus=B25, length_km=1, std_type="_150kv_type", name="LINE_B13B25")

    # Sortie Grid 2
    LINE_B10B21 = pp.create_line(net, from_bus=B10, to_bus=B21, length_km=1, std_type="_150kv_type", name="LINE_B10B21")
    LINE_B21B25 = pp.create_line(net, from_bus=B21, to_bus=B25, length_km=1, std_type="_150kv_type", name="LINE_B21B25")

    LINE_B23B24 = pp.create_line(net, from_bus=B23, to_bus=B24, length_km=1, std_type="_380kv_type", name="LINE_B23B24")
