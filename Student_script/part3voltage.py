...
# List of Shunts:
ShuntService = True
pp.create_shunt(net, bus=N104, q_mvar=-75.0, in_service=ShuntService)
pp.create_shunt(net, bus=N203, q_mvar=-45.0, in_service=True)
pp.create_shunt(net, bus=N206, q_mvar=-45.0, in_service=True)
pp.create_shunt(net, bus=N102, q_mvar=-75.0, in_service=ShuntService)
pp.create_shunt(net, bus=N202, q_mvar=-45.0, in_service=True)
pp.create_shunt(net, bus=N105, q_mvar=-75.0, in_service=ShuntService)
pp.create_shunt(net, bus=N205, q_mvar=-45.0, in_service=True)
pp.create_shunt(net, bus=N101, q_mvar=-75.0, in_service=ShuntService)
pp.create_shunt(net, bus=N201, q_mvar=-45.0, in_service=True)
pp.create_shunt(net, bus=N107, q_mvar=-75.0, in_service=ShuntService)
