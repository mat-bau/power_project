...
LOAD_N201 = pp.create_load(net, bus=N201, p_mw=360.0, q_mvar=180.0, name="N201", in_service=True, max_p_mw=360.*1.5, min_p_mw=360., max_q_mvar=180., min_q_mvar=180., controllable = True)
